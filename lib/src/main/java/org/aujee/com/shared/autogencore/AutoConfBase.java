package org.aujee.com.shared.autogencore;
...
import static org.aujee.com.shared.util.UtilBucket.getPrimitiveVal;
            ...
            try {
                MethodHandles
                        ...
                        .set(isString(varName_Value_SimpleType[2]) ?
                                ...
                                getPrimitiveVal(varName_Value_SimpleType[2], varName_Value_SimpleType[1]));
